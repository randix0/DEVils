...
require_once('./application/libraries/smarty/libs_3.1.5/Smarty.class.php');
	...
	class Tpl extends Smarty 
	{
		...
		private $_mainTpl = 'page.tpl';
		private $_structTplsDir = 'std/page/';
...
*/			
			...
			$this->assign('_userdata',$this->CI->session->all_userdata());
			if ($this->CI->session->userdata('users_id') > 0)
				$LOGGED = 1;
			else
				$LOGGED = 0;
